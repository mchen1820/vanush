...
from text_extractor import extract_pdf_bytes, extract_text  # noqa: E402
...
def build_metadata(source: str, article_text: str, claim_result: dict, author_result: dict) -> dict:
    ...
    title_guess = lines[0][:180] if lines else "Article"
    ...
    return {
        "title": title_guess,
        "author": author_result.get("author_name") or "Unknown",
